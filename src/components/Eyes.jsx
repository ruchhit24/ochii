...
const Eyes = () => {
  ...
  return (
    <div className="w-full h-screen -mt-20">
      <div className='w-full h-full mt-12 rounded-tl-3xl rounded-tr-3xl bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")]  bg-center bg-cover relative'>
