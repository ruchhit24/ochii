...
const Footer = () => {
  return (
    <div className='w-full h-screen bg-zinc-900 flex gap-5 rounded-tl-3xl rounded-tr-3xl absolute'>
    <div className='w-1/2 h-full flex flex-col justify-between px-10 py-28'>
        <div>
            <h1 className='text-9xl font-anton leading-none tracking-tight font-extralight text-gray-100'>EYE-OPENING</h1>
            <h2 className='text-5xl font-anton text-gray-100 leading-10'>OChio.</h2>
        </div>
        <div className='border-b-[1px] border-gray-400 pb-2'>
        <svg className='text-white' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className='w-1/2 h-full px-10 py-28'>
     <div className='border-b-[1px] w-1/2 border-gray-400'>
     <h1 className='text-7xl font-anton leading-none tracking-tight font-extralight text-gray-100'>Presentations.</h1>
     </div>
     <div className='pt-40 flex flex-col'>
     <h1 className='pb-8 text-3xl font-anton leading-10 tracking-tight font-extralight text-gray-100  '>Lets Meet.</h1>
     <a href='#' className='text-gray-200 text-xl pb-4 hover:scale-105 duration-300 cursor-pointer hover:border-b-[1px] w-1/5 border-gray-400   '>Facebook</a>
     <a href='#' className='text-gray-200 text-xl pb-4 hover:scale-105 duration-300 cursor-pointer hover:border-b-[1px] w-1/5 border-gray-400  '>Instagram</a>
     <a href='#' className='text-gray-200 text-xl pb-4 hover:scale-105 duration-300 cursor-pointer hover:border-b-[1px] w-1/5 border-gray-400  '>Twitter</a>
     </div>
